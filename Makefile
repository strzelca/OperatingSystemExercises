...
.PHONY: clear fork shm shm_read pipe pthreads workers shm_list shm_list_read usb
...
clear:
	rm -rf fork shm shm_read pipe pthreads workers shm_list shm_list_read usb